        ...
        <div class="table">
            <div class="header-text">
                <div class="row">
                    ...
                    $requete = 'Select DISTINCT Titre_Album, Album.Code_Album, Album.Pochette From Album';

                    echo '<p style="border-bottom: 1px solid grey; color:#333; margin-top:150px;"> Albums </p>';
                    echo '<br />';
                    foreach ($pdo->query($requete) as $row) {
                        echo '<br />';
                        echo '<img width="140px" height="120px" src="image_Album.php?Code_Album=' . $row['Code_Album'] . '" alt="Pas de photo">';
                        echo '<a style="margin-left: 30px; display:inline;" href="reponse_enregistrement.php?Album=' . $row['Code_Album'] . '">' . $row['Titre_Album'] . '</a>';
                        echo '<br />';
