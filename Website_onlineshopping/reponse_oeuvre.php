                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <section>
                            ...
                            $requete = 'select distinct Oeuvre.Code_Oeuvre, Titre_Oeuvre from Oeuvre
				          ...
				          Where Musicien.Code_Musicien =' . $Musicien . ' Order By Titre_Oeuvre';

                            echo '<p style="margin-top: -30px; margin-bottom: 25px; color: #2E2E2E; border-bottom: 1px solid grey"> Oeuvres </p>';
                            foreach ($pdo->query($requete) as $rod) {
                                echo '<a style="margin-top:20px; text-align: justify; text-decoration: none;" href="reponse_album.php?Oeuvre=' . $rod['Code_Oeuvre'] . '">' . $rod['Titre_Oeuvre'] . '</a>';
                                echo '<br />';
                            }
                            /*echo '<li><a href="reponse_musicien.php"> Retour </a></li>';*/
                            ?>
                            <br />
