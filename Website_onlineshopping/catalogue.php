            ...
            <div class="header-text">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <!-- Liste des lettres pour recherche par lettre -->

                        <?php
                        $number = 1;
                        $nb_lettres = 26;
                        while ($number < $nb_lettres)
                        {
                            $lettre = chr($number + ord('A') - 1);

                            echo '<a style="color: black; font-family: "Roboto"; text-decoration: none; href="reponse_musicien.php?musicien=' . $lettre . '%">' . $lettre . "  -  " . '</a>';
