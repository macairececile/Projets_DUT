            ...
            <div class="header-text">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <form method="get" action="Traite_Connexion.php?url=$SERVER['HTTP_REFERER']">
                            <label> Login : <input name="Login" type="text" / required="required"></label><br/>
                            <label style="margin-right:49px;"> Mot de passe : <input name="Password" type="password" required="required" /></label><br/>
